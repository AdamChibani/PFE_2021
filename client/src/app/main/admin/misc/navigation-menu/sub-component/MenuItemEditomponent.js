...
import IconPickField from '@catu/components/IconPickField/IconPickField';
...
import { PortalConfigs } from 'app/main/portal/portalConfigs';
 ...
 * Data for the form
 **/
const modules = PortalConfigs.map((item) => {
...
function MenuItemEditomponent(props) {
    ...
    useEffect(() => {
        if (editableItem && typeof editableItem === 'object' && editableItem.id) {
            ...
            // Detect type
            if (editableItem.url && (editableItem.url.startsWith('https://') || editableItem.url.startsWith('http://'))) {
                reset.type = 2; // This is a link
            } else if ((!editableItem.url && editableItem.data) || (editableItem.data && editableItem.data.length > 0)) {
                reset.type = 3; // This is a category
            } else { // Module
            ...
            setItem({
                ...
                ...editableItem,
                auth, 
                type: reset.type, // force the type
            });
    ...
    return (
        ...
        >
                ...
                }
                {
                    item.type === 3 && (
                        <Grid item xs={grid.typeAdd}>
                            ...
                            <Tooltip 
                                title={"Merci d’ajouter l’élément au menu afin de pouvoir éditer le contenu de la catégorie."}
                                open = {
                                    openTooltip && item.id === 0
                                }
            ...
            <TextFieldFormsy
                ...
                validationErrors={{
                    maxLength: '40 caractères au maximum',
                }}
                required
            />
