...
import VSelect from "react-select-virtualized";
...
function FuseChipSelect(props) {
  ...
  switch (props.variant) {
    case "virtualized":
      return (
        <VSelect
          classNamePrefix="virtualized-chip-select"
          {...props}
    ...
    case "fixed":
      return (
        <Select
          classNamePrefix="enhanced-chip-select"
          {...props}
          components={components}
          onChange={handleOnChange}
        />
...
export default React.memo(withFormsy(FuseChipSelect));
