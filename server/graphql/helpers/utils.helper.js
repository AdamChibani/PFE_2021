 ...
 */
const { Option } = require("../../database/models");
const fs = require("fs");
...
const utilsHelpers = {
  ...
  async uploadFile(data) {
    ...
    console.log(typeof uploadFolder);
    const ul = "E:/React/PFE/server/public/uploads/images/users/";
    // Save the file
    return await new Promise((resolve, reject) => {
      createReadStream()
        .pipe(fs.createWriteStream(path.join(ul, savedFileName)))
        .on("close", function () {
